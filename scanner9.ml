...
(* Hugh Dolliff Dolli028 
results from the test are as follow. no comments show up and the results match the desired results.  added a case for ';' in nextToken() and also added  let rec nextComment() =  above it so it would ignore comments 
